...
const Dashboard = () => {
  ...
  const transactions = [
    { typeimg: BTC, type: "BTC", action: "Deposit", user: "Maleekfrenzy", amount: "0.00023 BTC", date: "21 - 12 - 24", time: "11:23 AM" },
    { typeimg: usdt, type: "USDT", action: "Sending", user: "Alex", amount: "25,000 USDT", date: "21 - 12 - 24", time: "11:23 AM" },
    { typeimg: sol, type: "SOL", action: "Receiving", user: "Anita", amount: "0.00023 SOL", date: "21 - 12 - 24", time: "11:23 AM" },
    { typeimg: trx, type: "TRX", action: "Swap", user: "Zainy", amount: "0.00023 TRX", date: "21 - 12 - 24", time: "11:23 AM" },
    { typeimg: BTC, type: "BTC", action: "Deposit", user: "Balla", amount: "0.00023 BTC", date: "21 - 12 - 24", time: "11:23 AM" },
  ];

  // table display of crypto prices
  const cryptoPrices_headerTr = [
    'token',
    'price',
    'change'
  ]
  ...
  return (
    <>
      ...
      <div className='mt-14'>
        <h1 className='text-2xl font-bold mb-4'>Master Card</h1>
        <MasterCard
          heading={'crypto wallet'}
        />
      </div>
