...
const BarChart = () => {
    ...
    const [periodDropdownOpen, setPeriodDropdownOpen] = useState(false); // For the period dropdown
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                ...
                <div className="flex items-center justify-end gap-4">
                    ...
                    <Dropdown
                        ...
                        onChange={handleCategoryChange} // Pass handler
                    ...
                    <Dropdown
                        ...
                        onChange={handlePeriodChange} // Pass handler
