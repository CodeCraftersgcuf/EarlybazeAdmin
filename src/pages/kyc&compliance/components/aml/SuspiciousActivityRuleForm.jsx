...
const SuspiciousActivityRuleForm = ({ onSubmit, options }) => {
    // Initial form values
    const initialValues = {
        transactionType: '',
        condition: '',
    ...
    return (
        <div className="">
            <h2 className="text-white opacity-90 text-base my-2 mb-5">If any of the following rules are met</h2>
            <Formik
                    ...
                    <Form className="flex flex-col gap-4">
                        <div className="grid grid-cols-4 gap-4 p-4 bg-theme-dark shadow-md border border-green-900 rounded-lg">
                            <div>
                                ...
                                <ErrorMessage name="transactionType" component="div" className="text-red-500 text-sm" />
                            </div>
                            ...
                            <div className='flex flex-col gap-2'>
                                <div>
                                    <Field type="text" name="amount" placeholder="Amount in $" className="p-4 rounded-md mb-2 bg-[#042619] text-white placeholder:text-white w-full" />
                                    <ErrorMessage name="amount" component="div" className="text-red-500 text-sm" />
                                </div>
                                <div>
                                    <Field type="text" name="occurrences" placeholder="No of times" className="p-4 rounded-md mb-2 bg-[#042619] text-white placeholder:text-white w-full" />
                                    <ErrorMessage name="occurrences" component="div" className="text-red-500 text-sm" />
                                </div>
                            </div>
