...
const Notification_User = () => {
    ...
    const handleNotificationSubmit = ({value})=>{
        console.log(value, ' : notification_user')
    }
    ...
    return (
        <>
            <div className='flex items-center justify-between mb-[100px]'>
                ...
                <button className='py-2 px-4 text-white bg-[#25AE7A] rounded-lg' onClick={()=> setshowSendModel(true)}>Send New</button>
            </div>
