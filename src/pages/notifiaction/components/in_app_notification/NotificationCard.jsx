...
const NotificationCard = ({ title, message, attachment, date, onEdit, onDelete }) => {
    return (
        <div className="border border-[#25AE7A] rounded-lg bg-theme-dark p-6 w-full">
            ...
            <div className="flex items-end justify-around text-gray-300">
                <div className="">
                    ...
                    <img src={attachment ? attachment : "https://randomuser.me/api/portraits/men/22.jpg"} alt="attachment" className="w-12 h-12 rounded-md bg-gray-700" />
                </div>
