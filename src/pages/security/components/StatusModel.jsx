...
const StatusModel = ({ closeModal, onSubmit, initialData }) => {
    // Initial form values
                    ...
                    {({ isSubmitting }) => (
                        <Form className='flex flex-col gap-4'>
                            ...
                            <div>
                                ...
                                >
                                    <option value='' className='text-white hover:bg-[#25AE7A]'>Select Status</option>
                                    <option value='whitelisted' className='text-white hover:bg-[#25AE7A]'>Whitelisted</option>
                                    <option value='blacklisted' className='text-white hover:bg-[#25AE7A]'>Blacklisted</option>
                                </Field>
                                <ErrorMessage
                                    name='status'
                                    component='div'
