...
const TokenHolderTr = ({ displayData, index }) => {
    return (
            ...
            <td className='px-4 py-2'>
                <div className='flex items-center gap-4 px-4 py-2'>
                    ...
                    <div className='flex items-center gap-4'>
                        <img src={displayData.logo ? displayData.logo : `https://randomuser.me/api/portraits/${index % 2 !== 0 ? 'women':'men'}/4${index}.jpg`} alt={displayData.name} width="30" className='rounded-full' />
                        <div>
