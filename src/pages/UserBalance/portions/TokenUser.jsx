...
const TokenUser = () => {
    ...
    const handleSort = (sort) => {
        ...
        if (sort === 'highest') {
            sortedData.sort((a, b) => parseFloat(b.value.replace('$', '').replace(',', '')) - parseFloat(a.value.replace('$', '').replace(',', '')))
        } else if (sort === 'lowest') {
            sortedData.sort((a, b) => parseFloat(a.value.replace('$', '').replace(',', '')) - parseFloat(b.value.replace('$', '').replace(',', '')))
        }
