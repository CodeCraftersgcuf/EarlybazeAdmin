    ...
    return (
        <>
            <div className='flex items-center justify-between gap-8'>
                ...
                <div className='flex items-center gap-4'>
                    <Link to={`/user/management/customer/${profile_details.name}/bank/detail`} className='py-2 px-8 bg-green-600 rounded-lg'>Bank Details</Link>
                    <button onClick={() => setshoweditmodel(true)} className='py-2 px-8 bg-green-600 rounded-lg'>Edit Profile</button>
                </div>
            </div>
            ...
            <h1 className='text-4xl mb-8 tracking-widest'>Activities</h1>
            <div className='my-8'>
                <Dropdown
