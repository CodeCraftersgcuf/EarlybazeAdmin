...
const ProfileImg = ({ name, profileImg, joinDate ,backgroundimg }) => {
    return (
        <div className="relative bg-theme-dark rounded-lg text-white">
            <div className='absolute top-0 z-[1] bg-gradient-to-r from-[#0a3d2a] rounded-lg rounded-b-none to-[#2e5dd8] w-full h-28'>
                {backgroundimg && <img src={backgroundimg} alt="background" className='w-full h-full object-cover rounded-lg rounded-b-none' />}
            </div>
