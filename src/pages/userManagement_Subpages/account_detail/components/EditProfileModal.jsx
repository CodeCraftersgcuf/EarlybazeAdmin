...
const EditProfileModal = ({ closeModal, onSubmit, values }) => {
    // Initial form values
    ...
    const validationSchema = Yup.object({
        ...
        profileImage: Yup.mixed()
            ...
            .test('fileType', 'Unsupported file format. Only JPG, PNG, JPEG allowed.', (value) => {
        ...
        <Overlay>
            <div className="absolute top-10 right-10 bg-[#042619] p-8 shadow-lg shadow-gray-950 rounded-xl min-w-[400px] mx-auto">
                <div className="flex items-center justify-between relative mb-6">
                    <h2 className="text-xl font-bold text-white text-center w-full">Edit Profile</h2>
                    <button
