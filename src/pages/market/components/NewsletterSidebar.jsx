...
const NewsletterSidebar = ({ addSection }) => {
  return (
    <div className="col-span-3 bg-[#052B16] p-4 rounded-lg">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2 mt-2">
          <button onClick={() => addSection("heading")} className="flex flex-col items-center p-2 bg-[#031E11] rounded-md">
            <FaHeading className="text-2xl" />
            <p className="text-xs">Heading</p>
          </button>
          <button onClick={() => addSection("paragraph")} className="flex flex-col items-center p-2 bg-[#031E11] rounded-md">
            <FaParagraph className="text-2xl" />
            <p className="text-xs">Paragraph</p>
          </button>
          <button onClick={() => addSection("image")} className="flex flex-col items-center p-2 bg-[#031E11] rounded-md">
            <FaImage className="text-2xl" />
            <p className="text-xs">Image</p>
          </button>
          <button onClick={() => addSection("link")} className="flex flex-col items-center p-2 bg-[#031E11] rounded-md">
