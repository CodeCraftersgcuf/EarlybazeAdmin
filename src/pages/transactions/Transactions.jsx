...
import ReadCvLogo from '../../../assets/icons/ReadCvLogo.png';
...
const Transactions = () => {
  ...
  const handleCategory = (value) => {
    if (table_header_rows.hasOwnProperty(value)) {
      settableTh(table_header_rows[value]); // Update table headers
      settableBodyRow(table_body_rows[value] || []); // Update table body rows
    }
    setbodyRow(value)
  };
    ...
    <>
      ...
      <div className="mt-8">
        <TableCan
          ...
          dataTr={tableBodyRow}
          TrName={
            bodyRow === 'all' ? AccountTransactionsRow :
              bodyRow === 'send' ? SendTransactionsRow :
                bodyRow === 'receive' ? ReceiveTransactionsRow :
                  bodyRow === 'buy' ? BuyTransactionsRow :
                    bodyRow === 'swap' ? SwapTransactionsRow :
