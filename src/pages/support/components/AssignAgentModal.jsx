...
const AssignAgentModal = ({ closeModal, onSubmit, ticketNumber, agentOptions }) => {
    const initialValues = {
        agent: ''
    };
                    ...
                    {({ isSubmitting }) => (
                        <Form className='flex flex-col gap-4'>
                            <div>
                                ...
                                >
                                    <option value='' className="bg-[#042619] text-white hover:bg-[#25AE7A]">Select Agent</option>
                                    {agentOptions.map((agent, index) => (
                                        <option key={index} value={agent.value} className="bg-[#042619] text-white hover:bg-[#25AE7A]">
                                            {agent.name}
                                        </option>
                                    ))}
                                </Field>
