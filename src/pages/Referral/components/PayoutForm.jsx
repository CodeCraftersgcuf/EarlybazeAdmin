        ...
        >
            {({ isSubmitting }) => (
                <Form>
                    ...
                    <ErrorMessage name="signupOption" component="div" className="text-red-500 text-sm mt-1" />
                    <ErrorMessage name="tradeAmount" component="div" className="text-red-500 text-sm mt-1" />
                    ...
                    <ErrorMessage name="creditType" component="div" className="text-red-500 text-sm mt-1" />
                    <ErrorMessage name="creditAmount" component="div" className="text-red-500 text-sm mt-1" />
