...
const PayoutRules = () => {
    ...
    const table_th = ['User', 'Details', 'Accounts exempted', 'Transactions exempted', 'Date Created', 'Status', 'More'];
    const table_td = [
        {
            id: 1,
            user: "Rule 1",
            details: "User sign up with referral code and trade $20 daily credit users dollar wallet with $2",
